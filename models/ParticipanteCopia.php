...
/**
 * This is the model class for table "TB_ParticipanteCopia".
 *
 * @property string $Nro
 ...
 */
class ParticipanteCopia extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['Nro', 'CodGrupo', 'ApellidoPaterno', 'ApellidoMaterno', 'Nombres', 'Zona', 'Rut', 'Edad', 'Telefono', 'TallaPolera', 'CategoriaKms', 'Observaciones', 'Estado', 'LastModified'], 'required'],
